...
# How it works?
### This program is made to read CS2 memory and only that.
### It doesn't write anything to memory, anytime of mouse action is done using ```mouse_event```
# Credits:
